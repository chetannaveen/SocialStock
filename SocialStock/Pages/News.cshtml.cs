...
namespace SocialStock.Pages
{
    public class NewsModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(string CompanySymbol)
        {
            ...
            var responseNews = await client.GetAsync("https://finnhub.io/api/v1/company-news?symbol=" + CompanySymbol + "&from=2022-09-01&to=2022-10-09&token=cd7l922ad3iasq2munj0cd7l922ad3iasq2munjg");
            if (responseNews.IsSuccessStatusCode)
            {
                var financialNewsResult = await responseNews.Content.ReadAsStringAsync();
